    ...
    >
      ...
      <el-form-item prop="permissions" label="授权标识">
        <el-input
          ...
          placeholder="示例: system:menu:save,system:menu:update"
        ></el-input>
      </el-form-item>
      <el-form-item
      ...
      >
        ...
        >
          <div class="mod-system__menu-icon-inner">
            <div class="mod-system__menu-icon-list">
              <el-button
      ...
      <el-form-item label="详细说明" prop="detail" v-if="dataForm.type === 0">
        <el-input
          type="textarea"
...
export default {
  ...
  methods: {
    ...
    getInfo() {
      this.$http
        .get(`/system/menu/detail/${this.dataForm.id}`)
        .then(({ data: res }) => {
          if (res.code !== 0) {
            return this.$message.error(res.msg);
          }
    ...
    dataFormSubmitHandle: debounce(
      function () {
        this.$refs["dataForm"].validate((valid) => {
          ...
          this.$http
            .post(
              !this.dataForm.id ? "/system/menu/save" : "system/menu/update",
              this.dataForm
            )
            .then(({ data: res }) => {
              if (res.code !== 0) {
